...
<div class="row">
    ...
    <div class="col-lg-4 p-4">
        ...
        <a href="#" class="d-inline-block mb-2 text-dark text-decoration-none">New</a><br>
        <a href="#" class="d-inline-block mb-2 text-dark text-decoration-none">Books</a><br>
        <a href="#" class="d-inline-block mb-2 text-dark text-decoration-none">Shop</a><br>
    ...
    <div class="col-lg-4 p-4">
        ...
        <a href="" class="d-inline-block text-dark text-decoration-none mb-2">
            <i class="bi bi-facebook me1"> Facebook </i>
        </a><br>
